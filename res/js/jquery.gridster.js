...
;(function(root, factory) {
    ...
    */
    ...
    fn.init = function() {
        ...
        this.drag_api.set_limits_top(this.container_height);
    };
    ...
    * @return {HTMLElement} Returns instance of gridster Class.
    */
    fn.mutate_widget_in_gridmap = function($widget, wgd, new_wgd) { console.log('mutate_widget_in_gridmap');
...
//            this.set_dom_grid_height();
    ...
    * @param {Object} ui A prepared ui object with useful drag-related data
    */
    fn.on_drag = function(event, ui) { console.log('on_drag');
    ...
    */
    fn.on_overlapped_row_change = function(start_callback, end_callback) {
        ...
        //     if ($.inArray(this.last_rows[i], rows) === -1) {console.log('end_callback');
...
//        this.last_rows = rows;
    ...
    * @return {object}
    */
    fn.set_player = function(col, row, no_player) { console.log('set_player ' + col+', '+row);
        var self = this;
        if (!no_player) {
        ...
        console.log('manage_movements ' + to_col + ',' +to_row);
        console.log(constraints.can_not_go_up);
    ...
    */
    fn.manage_movements = function($widgets, to_col, to_row) {
        $.each($widgets, $.proxy(function(i, w) {
            ...
            console.log('can_go_widget_up: ' + can_go_widget_up);
...
//                    this.move_widget_down($w, y);
    ...
    * @return {Class} Returns the instance of the Gridster Class.
    */
    fn.set_placeholder = function(col, row) { console.log('set_placeholder ' + col + ',' + row);
    ...
    * @return {Class} Returns the instance of the Gridster Class.
    */
    fn.move_widget_to = function($widget, row) { console.log('move_widget_to: ' + row);
        var self = this;
    ...
    * @return {Class} Returns the instance of the Gridster Class.
    */
    fn.move_widget_up = function($widget, y_units) { console.log('move_widget_up: ' + y_units);
    ...
    * @return {Object} Returns the instance of the Gridster class.
    */
    fn.generate_faux_grid = function(rows, cols) {console.log('generate_faux_grid');
        this.faux_grid = [];
        this.gridmap = [];
        var col;
        var row;
